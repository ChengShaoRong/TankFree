...
{
    /// <summary>
    /// RongRong : This class include mothed 'Start/OnEnable/Update',
    /// we using 'HotUpdateBehaviourUpdate' to bind prefabe.
    /// </summary>
    public class TankShooting : LikeBehaviour // RongRong : Change 'MonoBehaviour' to 'LikeBehaviour'
    {
